...
const styles = StyleSheet.create({
  ...
  backButton: { width: 40, height: 40, borderRadius: 12, backgroundColor: COLORS.surface, alignItems: 'center', justifyContent: 'center' },
  ...
  refreshButton: { width: 40, height: 40, borderRadius: 12, backgroundColor: COLORS.surface, alignItems: 'center', justifyContent: 'center' },
  filters: { flexDirection: 'row-reverse', gap: 8, paddingHorizontal: 20, paddingBottom: 10, width: '100%', maxWidth: 1120, alignSelf: 'center' },
  filterButton: { flex: 1, minHeight: 42, borderRadius: 12, backgroundColor: COLORS.surface, alignItems: 'center', justifyContent: 'center' },
  ...
  jobCard: { flex: 1, minWidth: 0, backgroundColor: COLORS.surface, borderRadius: 20, padding: 16, borderWidth: 1, borderColor: COLORS.hairline, gap: 12 },
  ...
  destinationCard: { borderRadius: 14, borderWidth: 1, borderColor: COLORS.hairline, backgroundColor: COLORS.surface, padding: 12 },
  ...
  primaryAction: { minHeight: 50, borderRadius: 14, backgroundColor: COLORS.primary, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 8 },
