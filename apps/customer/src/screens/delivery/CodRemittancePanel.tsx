...
const styles = StyleSheet.create({
  ...
  sectionTitleWrap: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 10 },
  sectionIcon: { width: 38, height: 38, borderRadius: 12, backgroundColor: '#FEF3C7', alignItems: 'center', justifyContent: 'center' },
  sectionTitle: { color: '#111827', fontSize: 15, fontWeight: '800', textAlign: 'right' },
  ...
  collectionTopRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  ...
  statusBadge: { fontSize: 9.5, fontWeight: '800', paddingHorizontal: 8, paddingVertical: 5, borderRadius: 999, overflow: 'hidden' },
  ...
  submissionRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, paddingTop: 9, borderTopWidth: 1, borderTopColor: '#F3F4F6' },
  ...
  proofPicker: { minHeight: 66, borderRadius: 13, borderWidth: 1.5, borderColor: '#BFDBFE', backgroundColor: '#EFF6FF', flexDirection: 'row', alignItems: 'center', gap: 10, padding: 11, marginBottom: 13 },
  proofIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' },
  proofTitle: { color: '#1F2937', fontSize: 11.5, fontWeight: '800', textAlign: 'right' },
