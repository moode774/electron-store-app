...
const styles = StyleSheet.create({
  ...
  mapContainer: { minHeight: 156, borderRadius: 20, overflow: 'hidden', marginBottom: 16, backgroundColor: COLORS.primarySoft, borderWidth: 1, borderColor: COLORS.hairline },
  ...
  stepsCard: { backgroundColor: COLORS.surface, borderRadius: 20, padding: 20, borderWidth: 1, borderColor: COLORS.hairline, marginBottom: 16 },
  ...
  detailsCard: { backgroundColor: COLORS.surface, borderRadius: 20, padding: 20, borderWidth: 1, borderColor: COLORS.hairline },
  ...
  codBox: {
    ...
    backgroundColor: COLORS.primarySoft, borderRadius: 14, padding: 14, marginTop: 4,
  },
  ...
  actionBtn: { backgroundColor: COLORS.primary, height: 54, borderRadius: 15, alignItems: 'center', justifyContent: 'center' },
