...
const styles = StyleSheet.create({
  ...
  confirmProofBtn: { minHeight: 52, borderRadius: 13, backgroundColor: '#047857', flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: 14 },
