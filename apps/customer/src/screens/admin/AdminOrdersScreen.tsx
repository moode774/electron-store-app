...
const s = StyleSheet.create({
  ...
  searchBox: { maxWidth: 1280, alignSelf: 'center', marginTop: 16, minHeight: 48, borderWidth: 1, borderColor: UI.border, borderRadius: 13, backgroundColor: UI.bg, paddingHorizontal: 14, flexDirection: 'row-reverse', alignItems: 'center', gap: 10 },
