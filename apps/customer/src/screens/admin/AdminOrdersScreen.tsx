...
const s = StyleSheet.create({
  ...
  headerCount: { minHeight: 36, textAlignVertical: 'center', fontSize: 13, color: UI.primary, fontFamily: FONTS.semiBold, backgroundColor: UI.primaryLight, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, overflow: 'hidden' },
  searchBox: { maxWidth: 1280, alignSelf: 'center', marginTop: 16, minHeight: 48, borderWidth: 1, borderColor: UI.border, borderRadius: 13, backgroundColor: UI.card, paddingHorizontal: 14, flexDirection: 'row-reverse', alignItems: 'center', gap: 10 },
  ...
  closeBtn: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: UI.bg },
  detailBlock: { gap: 4 },
