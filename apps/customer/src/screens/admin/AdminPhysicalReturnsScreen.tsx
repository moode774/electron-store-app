...
const s = StyleSheet.create({
  ...
  filterButton: { minHeight: 38, justifyContent: 'center', paddingHorizontal: 14, paddingVertical: 9, borderRadius: 12, backgroundColor: UI.card, borderWidth: 1, borderColor: UI.border },
  ...
  list: { alignSelf: 'center', paddingTop: 12, paddingBottom: 96, gap: 14, flexGrow: 1 },
  columnRow: { gap: 12 },
  ...
  card: { flex: 1, minWidth: 0, backgroundColor: UI.card, borderRadius: 16, borderWidth: 1, borderColor: UI.border, padding: 17, gap: 13, shadowColor: COLORS.primaryDark, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.025, shadowRadius: 10, elevation: 1 },
  ...
  modalClose: { width: 44, height: 44, borderRadius: 13, backgroundColor: COLORS.surfaceMuted, alignItems: 'center', justifyContent: 'center' },
