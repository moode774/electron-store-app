...
const s = StyleSheet.create({
  ...
  filterButton: { minHeight: 44, justifyContent: 'center', paddingHorizontal: 14, paddingVertical: 9, borderRadius: 12, backgroundColor: UI.card, borderWidth: 1, borderColor: UI.border },
