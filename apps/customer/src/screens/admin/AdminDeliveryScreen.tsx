...
const s = StyleSheet.create({
  ...
  card: { flex: 1, minWidth: 0, backgroundColor: UI.card, borderRadius: 20, padding: 18, gap: 14, shadowColor: COLORS.primaryDark, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.02, shadowRadius: 12, elevation: 1, borderWidth: 1, borderColor: UI.border },
  ...
  modalBox: { maxWidth: 460, maxHeight: '90%', backgroundColor: UI.card, borderRadius: 20, padding: 22 },
