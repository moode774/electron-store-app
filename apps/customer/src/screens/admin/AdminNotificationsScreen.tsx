...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: UI.card, borderRadius: 20, padding: 20, shadowColor: COLORS.primaryDark, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.02, shadowRadius: 12, elevation: 1, borderWidth: 1, borderColor: UI.border },
  ...
  audienceCard: { minHeight: 96, alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 16, borderRadius: 13, backgroundColor: UI.card, borderWidth: 2, borderColor: UI.border },
  ...
  templateChip: { minHeight: 38, flexDirection: 'row-reverse', alignItems: 'center', gap: 6, backgroundColor: UI.primaryLight, paddingHorizontal: 13, paddingVertical: 8, borderRadius: 13, borderWidth: 1, borderColor: UI.primaryLight },
  templateChipText: { fontSize: 13, fontFamily: FONTS.semiBold, color: UI.primary },
  inputWrapper: { marginBottom: 12 },
  input: { backgroundColor: COLORS.surfaceMuted, borderRadius: 13, paddingHorizontal: 16, paddingVertical: 16, fontSize: 15, fontFamily: FONTS.medium, color: UI.text, borderWidth: 1, borderColor: UI.border },
  ...
  previewCard: { backgroundColor: '#FFFFFF', borderRadius: 20, padding: 16, flexDirection: 'row-reverse', alignItems: 'flex-start', gap: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.02, shadowRadius: 10, elevation: 1, borderWidth: 1, borderColor: UI.primaryLight },
  ...
  sendBtn: { minHeight: 56, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: UI.primary, borderRadius: 13, paddingVertical: 14, shadowColor: UI.primary, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 6, marginTop: 10 },
