...
const s = StyleSheet.create({
  ...
  searchBox: { maxWidth: 1280, alignSelf: 'center', flexDirection: 'row-reverse', alignItems: 'center', gap: 10, backgroundColor: UI.bg, paddingHorizontal: 16, borderRadius: 13, minHeight: 50, borderWidth: 1, borderColor: UI.border },
  ...
  card: { flex: 1, minWidth: 0, backgroundColor: UI.card, borderRadius: 20, padding: 18, shadowColor: COLORS.primaryDark, shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.02, shadowRadius: 12, elevation: 1, borderWidth: 1, borderColor: UI.border },
  ...
  approveBtn: { flex: 1, minHeight: 44, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: UI.success, borderRadius: 13, paddingVertical: 10, shadowColor: UI.success, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.070, shadowRadius: 8, elevation: 1 },
  ...
  modalContent: { maxWidth: 420, maxHeight: '90%', backgroundColor: UI.card, borderRadius: 20, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.07, shadowRadius: 20, elevation: 10 },
