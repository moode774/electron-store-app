...
const s = StyleSheet.create({
  ...
  approveBtn: { flex: 1, minHeight: 44, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: UI.primary, borderRadius: 13, paddingVertical: 10, shadowColor: UI.success, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.0250, shadowRadius: 8, elevation: 1 },
  ...
  modalContent: { maxWidth: 420, maxHeight: '90%', backgroundColor: UI.card, borderRadius: 20, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.025, shadowRadius: 20, elevation: 10 },
