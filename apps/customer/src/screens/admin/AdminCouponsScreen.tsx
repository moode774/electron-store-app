...
const s = StyleSheet.create({
  ...
  input: { minHeight: 48, borderWidth: 1, borderColor: UI.border, borderRadius: 13, paddingHorizontal: 16, backgroundColor: COLORS.surfaceMuted, fontSize: 15, fontFamily: FONTS.regular, color: UI.text },
  
  typeToggle: { flexDirection: 'row-reverse', minHeight: 48, backgroundColor: COLORS.surfaceMuted, borderRadius: 13, borderWidth: 1, borderColor: UI.border, overflow: 'hidden' },
  ...
  couponCard: { flex: 1, minWidth: 0, backgroundColor: UI.card, borderRadius: 16, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: UI.border },
