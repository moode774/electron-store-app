...
const styles = StyleSheet.create({
  ...
  list: { padding: 16, paddingTop: 2, gap: 12, paddingBottom: 80 },
  card: { backgroundColor: '#FFFFFF', borderRadius: 17, padding: 17, borderWidth: 1, borderColor: '#E2E8F0' },
  ...
  responseButton: { marginTop: 14, backgroundColor: '#111827', padding: 12, borderRadius: 11, alignItems: 'center' },
  ...
  retry: { backgroundColor: '#111827', paddingHorizontal: 17, paddingVertical: 10, borderRadius: 10 },
  retryText: { color: '#FFFFFF', fontWeight: '800' },
  modalOverlay: { flex: 1, backgroundColor: '#0F172A99', alignItems: 'center', justifyContent: 'center', padding: 20 },
  modal: { width: '100%', maxWidth: 500, backgroundColor: '#FFFFFF', borderRadius: 20, padding: 20 },
  ...
  cancel: { flex: 1, backgroundColor: '#F1F5F9', borderRadius: 11, padding: 12, alignItems: 'center' },
  cancelText: { color: '#64748B', fontWeight: '800' },
  confirm: { flex: 2, backgroundColor: '#111827', borderRadius: 11, padding: 12, alignItems: 'center' },
