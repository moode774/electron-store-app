      ...
      <View style={styles.orderCard}>
        ...
        <View style={styles.storeRow}>
          <View style={styles.storeIcon}>
            <Ionicons name="storefront-outline" size={17} color="#172554" />
          </View>
          <View style={styles.storeCopy}>
            <Text style={styles.storeNameText} numberOfLines={1}>{storeName}</Text>
            <Text style={styles.storeCaptionText}>تفاصيل الطلب والدفع</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  backBtn: {
    ...
    alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#E8EBF1',
  },
  headerCenterCol: { alignItems: 'center', flex: 1, paddingHorizontal: 8 },
  headerTitle: { fontFamily: FONTS.bold, fontSize: 20, color: '#111827', letterSpacing: -0.2 },
  headerSub: { fontFamily: FONTS.regular, fontSize: 11.5, color: '#7C8494', marginTop: 3 },
  supportPillBtn: {
    height: 42, flexDirection: 'row-reverse', alignItems: 'center', gap: 6,
    backgroundColor: '#F7F8FB', borderWidth: 1, borderColor: '#E8EBF1',
    borderRadius: 14, paddingHorizontal: 12,
  },
  supportPillText: { fontFamily: FONTS.bold, fontSize: 12, color: '#172554' },
  tabsContainer: { marginTop: 16, backgroundColor: '#F3F5F9', borderRadius: 16, padding: 4 },
  tabsScrollContent: { flexDirection: 'row-reverse', gap: 4, width: '100%' },
  tabChip: {
    flex: 1, minWidth: 72, height: 40, borderRadius: 12,
    alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10,
  },
  tabChipActive: {
    backgroundColor: '#172554',
    shadowColor: '#172554', shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.16, shadowRadius: 8, elevation: 3,
  },
  tabChipText: { fontFamily: FONTS.medium, fontSize: 12.5, color: '#737B8C' },
  tabChipTextActive: { fontFamily: FONTS.bold, color: '#FFFFFF' },
  loadingContainer: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  listContentContainer: { paddingHorizontal: 16, paddingTop: 16, paddingBottom: 120, gap: 14 },
  orderCard: {
    ...
    shadowOpacity: 0.055, shadowRadius: 18, elevation: 3,
  },
  cardHeaderRow: { flexDirection: 'row-reverse', alignItems: 'flex-start', justifyContent: 'space-between', gap: 10 },
  headerRightCol: { alignItems: 'flex-end', flex: 1 },
  orderNumberText: { fontFamily: FONTS.bold, fontSize: 15.5, color: '#111827' },
  dateSubRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: 4, marginTop: 4 },
  orderDateText: { fontFamily: FONTS.regular, fontSize: 11, color: '#98A0AE' },
  statusBadge: {
    minHeight: 30, flexDirection: 'row-reverse', alignItems: 'center',
    paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999, gap: 5,
  },
  statusBadgeText: { fontFamily: FONTS.bold, fontSize: 11.5 },
  storeRow: {
    flexDirection: 'row-reverse', alignItems: 'center', gap: 10, marginTop: 15,
    paddingTop: 14, borderTopWidth: 1, borderTopColor: '#F0F2F6',
  },
  storeIcon: {
    width: 38, height: 38, borderRadius: 12, backgroundColor: '#F1F4FF',
    alignItems: 'center', justifyContent: 'center',
  },
  storeCopy: { flex: 1, alignItems: 'flex-end' },
  storeNameText: { fontFamily: FONTS.bold, fontSize: 13.5, color: '#1F2937', textAlign: 'right' },
  storeCaptionText: { fontFamily: FONTS.regular, fontSize: 10.5, color: '#9AA2B1', marginTop: 2, textAlign: 'right' },
  priceRow: {
    flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between',
    marginTop: 13, backgroundColor: '#F8F9FC', borderRadius: 16, padding: 12,
  },
  priceCol: { alignItems: 'flex-end' },
  priceAmountText: { fontFamily: FONTS.bold, fontSize: 18, color: '#111827' },
  itemCountText: { fontFamily: FONTS.medium, fontSize: 10.5, color: '#7C8494', marginTop: 2 },
  paymentPill: {
    flexDirection: 'row-reverse', alignItems: 'center', gap: 6, backgroundColor: '#FFFFFF',
    borderWidth: 1, borderColor: '#E7EAF0', borderRadius: 12, paddingHorizontal: 10, paddingVertical: 7,
  },
  paymentPillText: { fontFamily: FONTS.medium, fontSize: 11, color: '#3E4655' },
  thumbnailsContainer: { flexDirection: 'row-reverse', gap: 8, marginTop: 13 },
  thumbnailWrapper: {
    width: 58, height: 58, borderRadius: 14, backgroundColor: '#F7F8FB',
    borderWidth: 1, borderColor: '#EAEDF2', overflow: 'hidden',
    alignItems: 'center', justifyContent: 'center',
  },
  thumbnailImage: { width: '100%', height: '100%' },
  stepperContainer: {
    flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center',
    marginTop: 18, paddingHorizontal: 2, backgroundColor: '#FBFCFE',
    borderRadius: 16, paddingTop: 12, paddingBottom: 10,
  },
  stepItem: { alignItems: 'center' },
  stepCircle: {
    width: 22, height: 22, borderRadius: 11, backgroundColor: '#F0F2F6',
    alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#D7DCE5',
  },
  stepCircleDone: { backgroundColor: '#172554', borderColor: '#172554' },
  stepCircleActive: { borderColor: '#172554', backgroundColor: '#EEF2FF' },
  stepDotInner: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#A7AFBC' },
  stepDotActiveInner: { backgroundColor: '#172554' },
  stepLabel: { fontFamily: FONTS.medium, fontSize: 9.5, color: '#9AA2B1', marginTop: 5 },
  stepLabelDone: { color: '#172554' },
  stepLabelActive: { fontFamily: FONTS.bold, color: '#172554' },
  stepLine: { flex: 1, height: 2, backgroundColor: '#E4E7ED', marginHorizontal: 4, marginBottom: 15 },
  stepLineDone: { backgroundColor: '#172554' },
  infoBannerBox: {
    backgroundColor: '#F8F9FC', borderRadius: 16, padding: 12, marginTop: 13,
    borderWidth: 1, borderColor: '#EEF0F4',
  },
  infoBannerRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: 7 },
  infoBannerText: { fontFamily: FONTS.regular, fontSize: 11.5, color: '#596273', flex: 1, textAlign: 'right' },
  infoBannerLabel: { fontFamily: FONTS.bold, color: '#30394A' },
  actionButtonsRow: { flexDirection: 'row-reverse', gap: 9, marginTop: 14 },
  trackPrimaryBtn: {
    flex: 1.15, height: 46, borderRadius: 14, backgroundColor: '#172554',
    flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 6,
    shadowColor: '#172554', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.16, shadowRadius: 8, elevation: 2,
  },
  trackPrimaryBtnText: { fontFamily: FONTS.bold, fontSize: 13, color: '#FFFFFF' },
  reorderPrimaryBtn: {
    flex: 1.15, height: 46, borderRadius: 14, backgroundColor: '#F1F4FF',
    borderWidth: 1, borderColor: '#DCE3FF', flexDirection: 'row-reverse',
    alignItems: 'center', justifyContent: 'center', gap: 6,
  },
  reorderPrimaryBtnText: { fontFamily: FONTS.bold, fontSize: 13, color: '#172554' },
  detailsSecondaryBtn: {
    flex: 0.85, height: 46, borderRadius: 14, backgroundColor: '#FFFFFF',
    borderWidth: 1, borderColor: '#E2E6ED', alignItems: 'center', justifyContent: 'center',
  },
  detailsSecondaryBtnText: { fontFamily: FONTS.bold, fontSize: 12.5, color: '#4D5666' },
  emptyContainer: { alignItems: 'center', justifyContent: 'center', marginTop: 72, paddingHorizontal: 28 },
